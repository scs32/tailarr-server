# Tailarr design system

The branded style guide for the Tailarr web controller. **Tailnet theme** —
slate surfaces + a cyan accent, dark-mode by default. Comps: CasaOS / Umbrel
(app-store feel) and Dockge (clean management panels).

## Files
- **`tailarr.css`** — the single source of truth: design tokens (color, type,
...
Each card becomes a React component with the same class contract; `tailarr.css`
