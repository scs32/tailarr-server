...
// serve`, so there are no on/off switches here. Polls while mounted so
// enrolling sidecars and busy pods settle into their real state without a
// reload. (A per-pod public/private Funnel toggle is planned — see backlog.)
  ...
  return (
    <>
      ...
      <p style={{ color: "var(--muted)", margin: 0 }}>
        ...
        MagicDNS name via <code>tailscale serve</code>.
      </p>
